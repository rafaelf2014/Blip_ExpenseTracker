...
Technical documentation for working on BLIP. If you just want to *run* the app, see the [root README](../README.md). These docs are for understanding how it's built and how to extend it.

## Contents

| Doc | What it covers |
|---|---|
| [architecture.md](architecture.md) | The big picture — frontend/backend split, folder layout, data flow, request lifecycle |
