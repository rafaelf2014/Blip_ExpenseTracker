...
This is a local demo. If this were ever to go further, the first steps would be: hash passwords (bcrypt/argon2), real auth tokens, and per-user authorization on every route.
