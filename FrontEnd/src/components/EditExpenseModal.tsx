  ...
  return (
    <ModalBase overlayClass="edit-modal-overlay" cardClass="edit-modal-card">
      ...
      <div className='form-fields'>
        <input className='edit-input' type="text" value={description} onChange={(e) => setDescription(e.target.value)} placeholder={t('editExpenseModal.description')} />
        <input className='edit-input' type="number" value={amount} onChange={(e) => setAmount(Number(e.target.value))} placeholder={t('editExpenseModal.amount')} />
