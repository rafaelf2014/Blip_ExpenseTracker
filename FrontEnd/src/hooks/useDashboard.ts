...
export function useDashboard() {
    ...
    const chartData = (() => {
        if (chartPeriod === 'week') {
            const data = [t('dates.short_weekdays.monday'), t('dates.short_weekdays.tuesday'), t('dates.short_weekdays.wednesday'), t('dates.short_weekdays.thursday'), t('dates.short_weekdays.friday'), t('dates.short_weekdays.saturday'), t('dates.short_weekdays.sunday')].map(n => ({ name: n, value: 0 }));
        ...
        if (chartPeriod === 'month') {
            const data = [`${t('dates.week')} 1`, `${t('dates.week')} 2`, `${t('dates.week')} 3`, `${t('dates.week')} 4`, `${t('dates.week')} 5`].map(n => ({ name: n, value: 0 }));
            expenses.forEach(exp => {
                const d = new Date(exp.date);
        ...
        const data = [t('dates.short_months.january'), t('dates.short_months.february'), t('dates.short_months.march'), t('dates.short_months.april'), t('dates.short_months.may'), t('dates.short_months.june'), t('dates.short_months.july'), t('dates.short_months.august'), t('dates.short_months.september'), t('dates.short_months.october'), t('dates.short_months.november'), t('dates.short_months.december')].map(n => ({ name: n, value: 0 }));
        expenses.forEach(exp => {
            const d = new Date(exp.date);
