                ...
                <div className="dashboard-container">
                    ...
                    <div className="dashboard-main">
                        ...
                        <div className="summary-boxes-container">
                            ...
                            <SummaryCard title={t('analytics.summary_expenses')} value={formatCurrency(stats.avgMonthlyExpense)} icon={TrendingDown} type="expense" />
                            <SummaryCard title={t('analytics.summary_daily')} value={formatCurrency(stats.avgDaily)} icon={DollarSign} type="balance" />
                            <SummaryCard title={t('analytics.summary_mostCategory')} value={t(`categories.${stats.topCategory.toLowerCase()}`, stats.topCategory)} icon={ShoppingCart} type="balance" />
                        </div>

                        <div className="charts-grid">
                            <div className="chart-card">
                                <h2>{t('analytics.title_graphicPizza')}</h2>
                            ...
                            <div className="chart-card">
                                <h2>{t('analytics.title_graphicLine')}</h2>
                                <div className="chart-wrapper">
